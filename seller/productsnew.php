                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="product-detail">
                                        <img src="../../images/products/bag.jpg" alt="Product 1">
                                        <div>
                                            <h3 class="mb-1">Apple Series 4 GPS A38 MM Space</h3>
                                            <h6 class="text-muted f-12 mb-0">Apple Watch SE Smartwatch</h6>
                                        </div>
                                    </div>
                                </td>
