...
<!-- [ Header ] end -->
  ...
  <div class="card">
    <div class="card-body">
      <h5 class="mb-4">User Actions</h5>
      
      <!-- User Logins -->
      <div class="mb-4">
        <h6 class="mb-3">User Logins</h6>
        <div class="table-responsive">
          <table class="table table-striped">
            ...
            <tbody>
              <tr>
                <td>john_doe</td>
                <td>2024-03-28 10:35 AM</td>
                <td>192.168.1.10</td>
              </tr>
              <!-- Add more login records as needed -->
            </tbody>
          </table>
        </div>
      </div>
      ...
      <!-- Account Creations -->
      <div class="mb-4">
        <h6 class="mb-3">Account Creations</h6>
        <div class="table-responsive">
          <table class="table table-striped">
            <thead>
              <tr>
            ...
            <tbody>
              ...
              <!-- Add more account creation records as needed -->
            </tbody>
          </table>
        </div>
      </div>
      ...
      <!-- Profile Updates -->
      <div>
        <h6 class="mb-3">Profile Updates</h6>
        <div class="table-responsive">
          <table class="table table-striped">
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                ...
                <td>2024-03-29 02:15 PM</td>
              </tr>
              <!-- Add more profile update records as needed -->
            </tbody>
          </table>
        </div>
      </div>
