...
<!-- [ Header ] end -->
  ...
  <div class="card">
    <div class="card-body">
      ...
      <!-- Overview Dashboard -->
      <div class="mb-4">
        <h6 class="mb-3">Overview Dashboard</h6>
        <div class="row">
          <div class="col-md-3">
      ...
      <!-- Product Performance -->
      <div class="mb-4">
        <h6 class="mb-3">Product Performance</h6>
        <!-- Add product performance charts or tables here -->
      </div>
      
      <!-- Geographic Analysis -->
      <div>
        <h6 class="mb-3">Geographic Analysis</h6>
        <!-- Add geographic analysis charts or tables here -->
      </div>
    </div>
  </div>
</div>
...
<script>
  // Sample data for sales trends chart
