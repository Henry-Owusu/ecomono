...
<!-- [ Header ] end -->
  ...
  <div class="pc-container">
    <div class="pc-content">
      ...
      <div class="row">
        <!-- [ sample-page ] start -->
        <div class="col-md-10"> <!-- Increased width to col-md-8 -->
            <div class="card">
                <div class="card-body">
                <h5 class="mb-4">Blog Posts</h5>
                
                <!-- Search and Filter -->
                <div class="mb-4">
                    <div class="input-group">
                    <input type="text" class="form-control" placeholder="Search for blog posts...">
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <td><img src="../../images/homepage/blog2.jpg" alt="Image 1" class="img-thumbnail" style="max-width: 100px;"></td>
                        ...
                        <tr class="table-info">
                        <td><img src="../../images/homepage/blog3.jpg" alt="Image 2" class="img-thumbnail" style="max-width: 100px;"></td>
                        <td>Tips for Effective Time Management</td>
                        <td>Jane Doe</td>
                        <td>2024-03-20</td>
                        <td>Draft</td>
                        </tr>
  ...
  <div class="card">
    <div class="card-body">
      <h5 class="mb-4">Post Management</h5>
