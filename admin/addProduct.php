              ...
              <div class="row">
                ...
                <form action="../actions/add_product_action.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Brand" name="productBrand">
                  </div>
                  <div class="form-group">
                    <label class="form-label">Price</label>
                    <input type="number" class="form-control" placeholder="Enter Product Price" name="productPrice">
                  </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Product Keywords" name="productKeyword">
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Eco-Friendly Material" name="productMaterial">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="btn btn-outline-secondary" type="file" id="productImage" name="productImage" accept="image/*">
                  </div>
