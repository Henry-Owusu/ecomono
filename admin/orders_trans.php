...
<!-- [ Header ] end -->
        ...
        <table class="table table-striped">
          ...
          <tbody>
            <tr class="table-success">
              ...
              <td>
                <a href="#" class="btn btn-sm btn-info"><i class="bi bi-eye"></i> View Details</a>
  ...
  <div class="card">
    <div class="card-body">
      <h5 class="mb-4">Transaction Monitoring</h5>
      ...
      <div class="mb-4">
        <div class="d-flex align-items-center justify-content-between">
          <div>
            ...
            <p>Overview of all payment transactions processed through the platform.</p>
          </div>
          <div>
        ...
        <div class="mt-3">
          <!-- Bar chart to visualize payment transactions -->
          <canvas id="paymentTransactionsChart" width="400" height="200"></canvas>
        </div>
      </div>
</div>
</div>
...
<script>
  // Sample data for payment transactions chart
  const paymentTransactionsChartData = {
  ...
  // Draw payment transactions chart
  const paymentTransactionsChart = new Chart(document.getElementById('paymentTransactionsChart').getContext('2d'), {
    type: 'bar',
    data: paymentTransactionsChartData,
    options: {
      scales: {
        y: {
          beginAtZero: true
