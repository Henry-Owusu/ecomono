...
$shops = viewAllShops_ctr();
$Categories = viewAllCategories_ctr();
// Retrieve product ID from URL
$productId = $_GET['pid'];
$product = viewProductDetails_ctr($productId);
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="productManagement.php">Product List</a></li>
            ...
            <div class="row">
                ...
                <form action="../actions/edit_product_action.php" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Product Name" name="productName" value="<?php echo $product['ProductName']; ?>">
                  </div>
                  <div class="form-group">
                    <label class="form-label">Brand</label>
                    <input type="text" class="form-control" placeholder="Enter Brand" name="productBrand" value="<?php echo $product['BrandName']; ?>">
                  </div>
                  <div class="form-group">
                    <label class="form-label">Price</label>
                    <input type="number" class="form-control" placeholder="Enter Product Price" name="productPrice" value="<?php echo $product['Price']; ?>">
                  </div>
                  <div class="form-group">
                      <label class="form-label">Category</label>
                      <select class="form-select" name="productCategory">
                          <?php foreach ($Categories as $Category) : ?>
                              <?php if ($Category['CategoryID'] == $product['Category']) : ?>
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-select" name="shop">
                          <?php foreach ($shops as $shop) : ?>
                              <?php if ($shop['ShopID'] == $product['shop']) : ?>
                                  <option value="<?php echo $shop['ShopID']; ?>" selected><?php echo $shop['ShopName']; ?></option>
                              <?php else : ?>
                  ...
                  <div class="form-group">
                      ...
                      <textarea class="form-control" placeholder="Enter Product Description" name="productDescription"><?php echo $product['Description']; ?></textarea> 
                  </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Product Keywords" name="productKeyword" value="<?php echo $product['Keywords']; ?>">
                  </div>
                  <div class="form-group">
                    <label class="form-label">Quantity</label>
                    <input type="number" class="form-control" placeholder="Enter Product Quantity" name="quantity" value="<?php echo $product['Quantity']; ?>">
                      </div>
                      <div class="form-group">
                    <label class="form-label">Eco-Friendly Material</label>
                    <input type="text" class="form-control" placeholder="Enter Eco-Friendly Material" name="productMaterial" value="<?php echo $product['Material']; ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <img src="<?php echo $product['productImage']; ?>" alt="Current Product Image" width="200">
                      <br>
                      <!-- File input for uploading a new image -->
                      <input class="btn btn-outline-secondary" type="file" id="productImage" name="newProductImage" accept="image/*">
                  </div>
                  <div class="form-group">
                    <input class="btn btn-outline-secondary" type="hidden" id="productImage" name="pid" value="<?php echo $product['ProductID']; ?>">
                  </div>
