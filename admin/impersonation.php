<?php 
    ...
    $userroles = viewAllUserRoles_ctr();
?>
...
<!-- [ Header ] end -->
  ...
  <div class="pc-container">
    <div class="pc-content">
      ...
      <div class="row">
        <!-- [ sample-page ] start -->
  <!-- User Switching Dropdown Menu -->
<div class="dropdown">
  <button class="btn btn-primary dropdown-toggle" type="button" id="userSwitchDropdown" data-bs-toggle="dropdown" aria-expanded="false">
    Switch User
  </button>
  <ul class="dropdown-menu" aria-labelledby="userSwitchDropdown">
    <!-- List of User Roles -->
    <?php foreach($userroles as $userrole): ?>
    <li><a class="dropdown-item" href="#" onclick="switchUser('customer')">"<?php echo $userrole['RoleName']; ?>"</a></li>
    <?php endforeach; ?>
  </ul>
</div>

<!-- JavaScript function to handle user switching -->
<script>
  function switchUser(role) {
    // Code to switch user context based on selected role
    // This function should handle the logic to switch to the corresponding dashboard, settings, permissions, and data associated with the selected role
    alert('Switching to ' + role + '...');
  }
</script>
