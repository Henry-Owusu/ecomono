...
<head>
  <title>Orders and Transactions</title>
  <!-- [Meta] -->
  <meta charset="utf-8">
...
<!-- [ Header ] end -->
  ...
  <div class="card">
    <div class="card-body">
      ...
      <div class="mb-4">
        <h6 class="mb-3">Platform Name and Description</h6>
        <form>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="platformDescription" rows="3" placeholder="Enter platform description"></textarea>
          </div>
      ...
      <div class="mb-4">
        <h6 class="mb-3">Platform Logo and Branding</h6>
        <form>
          <div class="mb-3">
            <label for="platformLogo" class="form-label">Platform Logo</label>
            <input type="file" class="form-control" id="platformLogo">
          </div>
          <!-- Additional branding options can be added here -->
          <button type="submit" class="btn btn-primary">Upload Logo</button>
        </form>
      </div>
      
      <!-- Platform URL and Domain Settings -->
      <div class="mb-4">
        <h6 class="mb-3">Platform URL and Domain Settings</h6>
        <form>
          <div class="mb-3">
            <label for="platformURL" class="form-label">Platform URL</label>
            <input type="text" class="form-control" id="platformURL" placeholder="Enter platform URL">
          </div>
          <div class="mb-3">
            <label for="platformDomain" class="form-label">Platform Domain</label>
            <input type="text" class="form-control" id="platformDomain" placeholder="Enter platform domain">
          </div>
          <!-- Additional domain settings options can be added here -->
          <button type="submit" class="btn btn-primary">Save Changes</button>
        </form>
      </div>
      
      <!-- Platform Language and Localization -->
      <div>
        <h6 class="mb-3">Platform Language and Localization</h6>
        <form>
          <div class="mb-3">
          ...
          <!-- Additional localization settings options can be added here -->
          <button type="submit" class="btn btn-primary">Save Changes</button>
        </form>
      </div>
    </div>
